...
import com.financeyun.commonlibrary.util.SharedPreferencesutil;
...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, final ImageListener listener) {
        return get(requestUrl, null, listener, 0, 0);
    }

    public ImageContainer get(String requestUrl, String listkey,
                              final ImageListener listener) {
        return get(requestUrl, listkey, listener, 0, 0);
    }
    ...
    public ImageContainer get(String requestUrl, String listkey,
                              final ImageListener listener, int nettype) {
        this.netType = nettype;
        return get(requestUrl, listkey, listener, 0, 0);
    }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        return get(requestUrl, null, imageListener, maxWidth, maxHeight);
    ...
    public ImageContainer get(String requestUrl, final String listkey,
        ...
        boolean is = SharedPreferencesutil.getLoadImagBoolean(context);
        ...
        // 在加载图片时去掉以前在同一个ImageView上的还没加载好的图片请求
        if (listkey != null) {
     ...
     */
    private void onGetImageSuccess(String cacheKey, String listkey,
                                   Bitmap response) {
     ...
     *            The cache key that is associated with the image request.
     */
    private void onGetImageError(String cacheKey, String listkey,VolleyError error) {
    ...
    public class ImageContainer {
        ...
        public ImageContainer(Bitmap bitmap, String requestUrl,
                              String cacheKey, ImageListener listener, String listkey) {
            mBitmap = bitmap;
